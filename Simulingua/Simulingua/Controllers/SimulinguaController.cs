...
namespace Simulingua.Controllers
{
    ...
    public class UserInfoController : ControllerBase
    {
        ...
        public IActionResult addNewUser(string uEmail, string uName, int bYear, int bMonth, int bDay, string oLang, string tLang, int ptLang)
        {
            ...
            try
            {
                ...
                return Ok(SqlTableOperations.addNewUser(uEmail, uName, bDate, oLang, tLang, ptLang));
            }
            catch (Exception e)
            {
        ...
        public IActionResult addNewTargetLanguage(string uEmail, string tLang, int ptLang)
        {
            ...
            try
            {
                return Ok(SqlTableOperations.addNewTargetLang(uEmail, tLang, ptLang));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult updateUser(string uEmail, string nuEmail, string nuName)
        {
            ...
            try
            {
                return Ok(SqlTableOperations.updateUser(uEmail, nuEmail, nuName));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult updateTargetLanguageProficiency(string uEmail, string uTargetLanguage, int uProficiency)
        {
            ...
            try
            {
                return Ok(SqlTableOperations.updateTargetLanguageProficiency(uEmail, uTargetLanguage, uProficiency));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult fetchUserInfo(string uEmail)
        {
            try
            {
                return Ok(SqlTableOperations.fetchUserInfo(uEmail));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult fetchUserTargetLanguages(string uEmail)
        {
            try
            {
                return Ok(SqlTableOperations.fetchUserTargetLanguages(uEmail));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult fetchCustomerReciepts(string uEmail)
        {
            try
            {
                return Ok(SqlTableOperations.fetchCustomerReciepts(uEmail));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult deleteUserTargetLanguage(string uEmail, string uTargetLanguage)
        {
            try
            {
                return Ok(SqlTableOperations.deleteUserTargetLanguage(uEmail, uTargetLanguage));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
    ...
    public class AdminActionsController : ControllerBase
    {
        ...
        public IActionResult addNewLanguage(string aLanguage)
        {
            try
            {
                return Ok(SqlTableOperations.addNewLanguage(aLanguage));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult addNewLanguageCourse(string originLanguage, string targetLanguage, int proficiencyLevel, double price)
        {
            ...
            try
            {
                return Ok(SqlTableOperations.addNewLanguageCourse(originLanguage, targetLanguage, proficiencyLevel, price));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult updateLanguageCoursePrice(string itemID, double price)
        {
            ...
            try
            {
                return Ok(SqlTableOperations.updateLanguageCoursePrice(itemID, price));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult deleteLanguageCourse(int itemID)
        {
            try
            {
                return Ok(SqlTableOperations.deleteLanguageCourse(itemID));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult fetchAllUserInfo()
        {
            try
            {
                return Ok(SqlTableOperations.fetchAllUserInfo());
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult fetchAllCustomerReciepts()
        {
            try
            {
                return Ok(SqlTableOperations.fetchAllCustomerReciepts());
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
    ...
    public class StoreActionsController : ControllerBase
    {
        ...
        public IActionResult userActionPurchaseLanguageCourse(string uEmail, int itemID)
        {
            try
            {
                return Ok(SqlTableOperations.userActionPurchaseLanguageCourse(uEmail, itemID));
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
        ...
        public IActionResult fetchStoreMenu()
        {
            try
            {
                return Ok(SqlTableOperations.fetchStoreMenu());
            }
            catch (Exception e)
            {
                return BadRequest(e.Message);
